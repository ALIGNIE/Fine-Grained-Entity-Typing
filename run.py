...
if __name__ == "__main__":
    ...
    parser.add_argument('--new_inst_num', default=5,type=int)
    parser.add_argument('--add_new_inst', default=1,type=int)
    ...
    with open(os.path.join('results', dataset, 'few_shot.txt'), 'a') as fout:
        ...
        for i in range(15):
            train_file = os.path.join('data', dataset, dataset+'_few_shot_'+str(i)+'.json')
                ...
                for epoch in range(N_EPOCHS):
                    ...
                    if epoch < N_EPOCHS/2:
                        ...
                        train_loss, train_acc, train_macro_f1, train_micro_f1, train_pos_loss, train_neg_loss,\
                            keywords_list, ensem_score = train_func(epoch, N_EPOCHS, pos_data, None, \
                            random_iter, BATCH_SIZE, word2label=None, fix_encoder = False, lambd = lambd, project=project,\
                            keywords_list = keywords_list, add_new_instance=add_new_inst, sample_num=epoch-10+1,\
        ...
        train_acc_average /= 15
        train_micro_f1_average /= 15
        train_macro_f1_average /= 15
        test_acc_average /= 15
        test_micro_f1_average /= 15
        test_macro_f1_average /= 15
